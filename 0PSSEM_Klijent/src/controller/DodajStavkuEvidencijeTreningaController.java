...
public class DodajStavkuEvidencijeTreningaController {
    ...
    public void pripremiFormu(FormaMod mod) {
        ...
        if (mod.equals(FormaMod.DODAJ)) {
            ...
            StavkaEvidencijeTreninga set = (StavkaEvidencijeTreninga) cordinator.Cordinator.getInstance().vratiParam("stavkaEvidencijaTreninga");
            ...
            LocalDate datumLocal = toLocalDateSafe.apply(set.getDatumPrisustva());

            dsetf.getTxtDan().setText(String.valueOf(datumLocal.getDayOfMonth()));
            dsetf.getTxtMesec().setText(String.valueOf(datumLocal.getMonthValue()));
            dsetf.getTxtGodina().setText(String.valueOf(datumLocal.getYear()));
            dsetf.getTxtOcena().setText(String.valueOf(set.getOcena()));
            dsetf.getCbxTrening().setSelectedItem(set.getTrening());
        }
    }
    ...
    private void addActionListeners() {
        ...
        dsetf.dodajAddActionLisener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    cordinator.Cordinator.getInstance().dodajUListuDodatih(stavka);
        ...
        dsetf.azurirajAddActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                EvidencijaTreninga et = (EvidencijaTreninga) cordinator.Cordinator.getInstance().vratiParam("evidencijaTreninga");
                ...
                int rb = et.getStavke().size() + 1;
                StavkaEvidencijeTreninga stavka1 = (StavkaEvidencijeTreninga) cordinator.Cordinator.getInstance().vratiParam("stavkaEvidencijaTreninga");
                StavkaEvidencijeTreninga stavka = new StavkaEvidencijeTreninga(et, stavka1.getRb(), utilDatumPrisustva, ocena, trening);

                try {

                    cordinator.Cordinator.getInstance().dodajUListuIzmenjenih(stavka);
                    JOptionPane.showMessageDialog(null, "Sistem je zapamtio stavku evidencije treninga");
